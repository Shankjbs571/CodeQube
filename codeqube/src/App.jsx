...
function App() {
  ...
  return (
    ...
    // <div className="flex h-screen bg-gray-800 " className="{ 'overflow-hidden': isSideMenuOpen }">
    ...
    //                         <p className="text-2xl text-green-500 font-semibold">SA </p> <p className="ml-2 font-semibold italic">
    //                         DASHBOARD</p>
    //                     </div>
    //                 </div>
    //                 <div className="flex justify-center">
    //                     <div className="">
    //                         <img className="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400"
    ...
    //                                     className="ml-1  text-white w-4 h-4" fill="none" viewBox="0 0 24 24"
    ...
    //                             <div x-showtransition="Open" style="display:none;">
